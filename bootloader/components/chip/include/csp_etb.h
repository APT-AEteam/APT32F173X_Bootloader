...
#define	ETB_CH0_TRG_DST(val)	(((val) & 0x7Ful) << ETB_CH0_TRG_DST_POS)
...
#define	ETB_CHX_TRG_SRC(val)	(((val) & 0x7Ful) << ETB_CHX_TRG_SRC_POS)

//destination
#define	ETB_CHX_TRG_DST_POS		(24U)	//CHx(3->31) trigger destination select
#define	ETB_CHX_TRG_DST_MSK		(0xFFul << ETB_CHX_TRG_DST_POS)
#define	ETB_CHX_TRG_DST(val)	(((val) & 0xFFul) << ETB_CHX_TRG_DST_POS)
